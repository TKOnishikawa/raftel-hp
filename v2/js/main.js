/* ========================================
   omoshiku v2 — GSAP ScrollTrigger Animations
   ======================================== */
...
function initNavigation() {
  ...
  const sections = ["#hero", "#problem", "#approach", "#services", "#numbers", "#about", "#contact"];
  sections.forEach(id => {
  ...
  // Smooth scroll for anchor links (native scroll-behavior: smooth)
